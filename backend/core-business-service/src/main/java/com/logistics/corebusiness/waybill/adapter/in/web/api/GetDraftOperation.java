...
/**
 * Аннотация для документирования endpoint получения черновика по ID.
 *
 * @Operation для Swagger
 * - summary: "Получить черновик по ID"
 * - description: "Возвращает информацию о черновике накладной. Пользователь может получить только свои черновики."
