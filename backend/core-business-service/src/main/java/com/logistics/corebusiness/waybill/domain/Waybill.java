 ...
 * Создается из WaybillDraft после того, как посылка физически принята и взвешена.
 *
 * <h2>Жизненный цикл</h2>
 * 1. Клиент создает черновик (WaybillDraft) через веб/мобильное приложение
 ...
 *
 * @see WaybillDraft для черновика до приемки
