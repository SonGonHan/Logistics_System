...
import com.logistics.userauth.notification.sms.adapter.out.persistence.RedisSmsRepository;
...
class RedisSmsRepositoryTest {
    ...
    void shouldFindVerificationCodeByPhone() {
        ...
        // When
        Optional<SmsVerificationCode> result = repository.findById(phone);
    ...
    void shouldMarkPhoneAsVerified() {
        ...
        // When
        repository.markAsVerified(phone, ttl);
    ...
    void shouldCheckIfPhoneIsVerified() {
        ...
        // When
        boolean result = repository.isVerified(phone);
