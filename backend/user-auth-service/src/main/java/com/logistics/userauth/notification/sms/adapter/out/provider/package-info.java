 ...
 *
 * <h2>Назначение</h2>
 * Реализации {@link com.logistics.userauth.notification.sms.application.port.out.SendSmsPort},
 ...
 * </ul>
 *
 * @see com.logistics.userauth.notification.sms.adapter.out.provider.MockSmsProvider
 * @see com.logistics.userauth.notification.sms.adapter.out.provider.SmscSmsProvider
 * @see com.logistics.userauth.notification.sms.application.port.out.SendSmsPort
 */
package com.logistics.userauth.notification.sms.adapter.out.provider;
