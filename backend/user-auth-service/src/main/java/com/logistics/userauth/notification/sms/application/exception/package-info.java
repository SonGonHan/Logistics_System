 ...
 * <h2>Исключения</h2>
 * <ul>
 *   <li><b>{@link com.logistics.userauth.notification.sms.application.exception.InvalidVerificationCodeException}</b> —
 *       неверный код или истек срок действия</li>
 *   <li><b>{@link com.logistics.userauth.notification.sms.application.exception.RateLimitExceededException}</b> —
 *       превышен лимит запросов</li>
 *   <li><b>{@link com.logistics.userauth.notification.sms.application.exception.SmsDeliveryException}</b> —
