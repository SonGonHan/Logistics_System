 ...
 * <h2>Состав</h2>
 * <ul>
 *   <li><b>{@link com.logistics.userauth.sms.adapter.in.validation.SmsCode}</b> — аннотация для проверки формата SMS-кода.</li>
 *   <li><b>{@link com.logistics.userauth.sms.adapter.in.validation.SmsCodeValidator}</b> — реализация проверки (цифры и длина из конфигурации).</li>
 * </ul>
 *
 * <h2>Конфигурация</h2>
